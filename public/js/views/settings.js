  ...
  section.innerHTML = `
    <div class="card" style="border-color:var(--red)">
      ...
      <p style="margin:0 0 10px;color:var(--text-dim);font-size:0.85rem;line-height:1.75">
        ...
        التبديلات، ديون الشركاء، ديون الناس ودفعاتها، وسجل توزيعات الأرباح — وكذلك كل النسخ الاحتياطية القديمة.
      </p>
      ...
      <p style="margin:0 0 14px;color:var(--amber);font-size:0.85rem;line-height:1.75">
        انتبه: النسخة الاحتياطية ترجّع السجلات بس — صور السيارات تنمسح نهائياً من
        التخزين وما تكدر ترجعها. إذا تريد تحتفظ بصورة، نزّلها قبل الحذف.
      </p>
      <div class="field">
